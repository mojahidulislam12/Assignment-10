  ...
  const clientPlans = [
    {
      ...
      period: "/forever",
      description:
        "Perfect for clients looking to hire legal professionals occasionally.",
      icon: <Person className="w-5 h-5 text-zinc-400" />,
      features: [
        "Browse unlimited lawyers",
        "Send up to 3 hire requests per month",
  ...
  const lawyerPlans = [
    {
      ...
      period: "/forever",
      description:
        "Create your lawyer profile and start receiving client requests.",
      icon: <Briefcase className="w-5 h-5 text-zinc-400" />,
      features: [
        "Public lawyer profile",
        "Receive up to 10 hire requests per month",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-3xl mx-auto border-t border-zinc-800 pt-16">
          <div className="text-center mb-10">
            <CircleQuestion className="w-10 h-10 mx-auto mb-3 text-zinc-400" />
                ...
                >
                  ...
                  <div
                    className={`overflow-hidden transition-all duration-300 ${
                      isOpen ? "max-h-40 border-t border-zinc-800" : "max-h-0"
                    }`}
                  >
